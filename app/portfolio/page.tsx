...
export default function PortfolioApp() {
  ...
  return <main className="portfolio-app">
    ...
    <section className="portfolio-contact" id="contact"><p>03 / CONTACT</p><div><h2>Have an idea worth<br/><i>building?</i></h2><p>I&apos;m open to internships, collaborations, and thoughtful product conversations.</p><div className="portfolio-contact-actions"><a href="mailto:adarshkhare269@gmail.com"><Mail size={16}/> Write an email</a><button type="button" onClick={copyEmail}>{copied ? "Email copied" : "Copy email"}</button></div><code>adarshkhare269@gmail.com</code></div></section>
